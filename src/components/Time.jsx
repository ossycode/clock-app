export default function Time() {
  return (
    <div>
      <div className="greeting-container heading_4">
        ...
        <p className="greetings uppercase">
          <span>Good Morning,</span> it's currently
        </p>
      </div>

      <div className="time-container">
        <p className="time heading_1">11:37</p>
        <p className="timezone uppercase">bst</p>
      </div>

      <p className="location uppercase heading_3"> in london, uk</p>
    </div>
  );
}
